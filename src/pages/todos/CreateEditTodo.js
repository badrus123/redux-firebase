...
import {
  uploadImage,
  uploadImageInit,
} from '../../redux/actions/upload_image_action'
import {
  createTodo,
  createTodoTypes,
  initializeCreateTodo,
} from '../../redux/actions/create_todo_action'
import {
  editTodo,
  editTodoTypes,
  initializeEditTodo,
} from '../../redux/actions/edit_todo_action'
import CreateTodoButton from '../home/component/Button'
...
function CreateEditTodo(props) {
  ...
  return (
    <div>
      <h1 className='title'>Hello: {getMeState?.username}</h1>

      <CreateTodoButton navigation={props.history} />
      <Row justify='center' a>
        <Col>
          <div style={{ marginTop: 50 }} className='createtodocontainer'>
            <Form
              initialValues={{
                header: props.location.state.isEdit
                  ? props.location.state.item.header
                  : '',
                description: props.location.state.isEdit
              ...
              <Form.Item name='upload' label='Upload'>
                ...
                <Search
                  readOnly
                  placeholder={uploadImageState?.imageUrl}
                  enterButton='Upload'
              ...
              <Form.Item>
                <Button id='nextButton' htmlType='submit'>
